...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rvMaps.layoutManager =
            LinearLayoutManager(this@MainActivity) // this will have vertical layout manager by default

        //store the sample data using the the generate function:
        val userMaps = generateSampleData()

        // set the adapter on the recycler view
        rvMaps.adapter = MapsAdapter(this@MainActivity, userMaps)
